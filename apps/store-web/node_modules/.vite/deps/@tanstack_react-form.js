...
var require_with_selector_development = __commonJS({
  "../../node_modules/.pnpm/use-sync-external-store@1.6.0_react@19.2.4/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      var React2 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = shim.useSyncExternalStore, useRef2 = React2.useRef, useEffect2 = React2.useEffect, useMemo4 = React2.useMemo, useDebugValue = React2.useDebugValue;
...
function createReactiveSystem({
  ...
  function link2(dep, sub, version2) {
    ...
    if (prevSub !== void 0 && prevSub.version === version2 && prevSub.sub === sub) {
      return;
    }
...
// ../../node_modules/.pnpm/@tanstack+react-form@1.28.6_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@tanstack/react-form/dist/esm/createFormHook.js
var import_jsx_runtime4 = __toESM(require_jsx_runtime(), 1);
var import_react7 = __toESM(require_react(), 1);

// ../../node_modules/.pnpm/@tanstack+react-form@1.28.6_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@tanstack/react-form/dist/esm/useForm.js
var import_jsx_runtime2 = __toESM(require_jsx_runtime(), 1);
var import_react5 = __toESM(require_react(), 1);

// ../../node_modules/.pnpm/@tanstack+react-form@1.28.6_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@tanstack/react-form/dist/esm/useField.js
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var import_react3 = __toESM(require_react(), 1);

// ../../node_modules/.pnpm/@tanstack+react-form@1.28.6_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@tanstack/react-form/dist/esm/useIsomorphicLayoutEffect.js
var import_react2 = __toESM(require_react(), 1);
var useIsomorphicLayoutEffect = typeof window !== "undefined" ? import_react2.useLayoutEffect : import_react2.useEffect;

// ../../node_modules/.pnpm/@tanstack+react-form@1.28.6_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@tanstack/react-form/dist/esm/useField.js
function useField(opts) {
  const [prevOptions, setPrevOptions] = (0, import_react3.useState)(() => ({
    form: opts.form,
    name: opts.name
  }));
  const [fieldApi, setFieldApi] = (0, import_react3.useState)(() => {
    return new FieldApi({
      ...opts
    });
  });
  ...
  const extendedFieldApi = (0, import_react3.useMemo)(() => {
...
var Field = (({
  ...
  const jsxToDisplay = (0, import_react3.useMemo)(
...
// ../../node_modules/.pnpm/@tanstack+react-form@1.28.6_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@tanstack/react-form/dist/esm/useFormId.js
var React = __toESM(require_react(), 1);

// ../../node_modules/.pnpm/@tanstack+react-form@1.28.6_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@tanstack/react-form/dist/esm/useUUID.js
var import_react4 = __toESM(require_react(), 1);
function useUUID() {
  return (0, import_react4.useState)(() => uuid())[0];
}
...
function useForm(opts) {
  ...
  const [prevFormId, setPrevFormId] = (0, import_react5.useState)(opts?.formId);
  const [formApi, setFormApi] = (0, import_react5.useState)(() => {
  ...
  const extendedFormApi = (0, import_react5.useMemo)(() => {
    const extendedApi = {
      ...formApi,
      handleSubmit: ((...props) => {
  ...
  const hasRan = (0, import_react5.useRef)(false);
  useIsomorphicLayoutEffect(() => {
...
// ../../node_modules/.pnpm/@tanstack+react-form@1.28.6_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@tanstack/react-form/dist/esm/useFieldGroup.js
...
function useFieldGroup(opts) {
  const [formLensApi] = (0, import_react6.useState)(() => {
...
function createFormHook({
  ...
  function useAppForm(props) {
    ...
    const AppForm = (0, import_react7.useMemo)(() => {
      return ({ children }) => {
        return (0, import_jsx_runtime4.jsx)(formContext2.Provider, { value: form, children });
      };
    }, [form]);
    const AppField = (0, import_react7.useMemo)(() => {
    ...
    const extendedForm = (0, import_react7.useMemo)(() => {
  ...
  function withFieldGroup({
    ...
    return function Render(innerProps) {
      const fieldGroupProps = (0, import_react7.useMemo)(() => {
        return {
