...
import { MdLogout, MdNotificationsNone, MdStorefront } from "react-icons/md";
...
export const Header = () => {
  ...
  const { shop, shopId, paths } = useShop();
  ...
  return (
    <div className="h-[56px] w-full flex justify-between items-center gap-3 px-6 border-b border-gray-200 bg-white shrink-0">
      <div className="flex items-center gap-2 min-w-0">
        <MdStorefront size={18} className="text-gray-400 shrink-0" />
